        ...
        function AsteroidField(player, colors, numAsteroids, radius) {
            ...
            this.asteroids = Utils.range(numAsteroids, function () {
                ...
                return new Polygon({
                    ...
                    velocity: Vector.random(-1, 1, -1, 1), size: size,
